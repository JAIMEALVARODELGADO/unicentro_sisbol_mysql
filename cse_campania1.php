...
<table class='Tb0' width='70%'>
    <tr>
        <td class='Td2' width='25%' align='right'>
            <a href='cse_campania11.php'>
                <img src='img/32px-Crystal_Clear_mimetype_document2.png' border=0 height='20' width='20' alt='Regresar' title="Crear nueva Campaña">
            </a>
        </td>
        <td class='Td2' width='25%' align='left'>
            <a href='cse_campania11.php' title="Crear nueva Campaña">Nueva Campaña</a>
        </td>
    </tr>
</table>
