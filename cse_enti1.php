...
<br><br><br><br><br>
<?php
$consulta = "SELECT nit_ent, nomb_ent, valxb_ent, fini_sor, ffin_sor FROM entidad";
...
<table class='Tbl0' width='100%' border='0'>
    <tr>
        ...
        <td class='Td2' width='15%' align='left'>
            <input type='text' name='nit_ent' size='12' maxlength='12' value='<?php echo $row['nit_ent']; ?>'>
        </td>
        <td class='Td2' width='15%' align='right'>Nombre:</td>
        <td class='Td2' width='25%' align='left'>
            <input type='text' name='nomb_ent' size='50' maxlength='50' value='<?php echo $row['nomb_ent']; ?>'>
        </td>
        <td class='Td2' width='20%' align='right'>Valor para cada boleta:</td>
        <td class='Td2' width='10%' align='left'>
            <input type='text' name='valxb_ent' size='6' maxlength='6' value='<?php echo $row['valxb_ent']; ?>'>
        </td>
    </tr>
    <tr>
        <td class='Td2' width='15%' align='right'>Fecha inicial para sorteo (dd/mm/yyyy):</td>
        <td class='Td2' width='15%' align='left'>
            <input type='text' name='fini_sor' size='10' maxlength='10' value='<?php echo cambiafechadmy($row['fini_sor']); ?>'>
        </td>
        <td class='Td2' width='15%' align='right'>Fecha final para sorteo (dd/mm/yyyy):</td>
        <td class='Td2' width='25%' align='left'>
            <input type='text' name='ffin_sor' size='10' maxlength='10' value='<?php echo cambiafechadmy($row['ffin_sor']); ?>'>
        </td>
    </tr>
</table>
<br>
<table class='Tb0' width='70%'>
    <tr>
        <td class='Td2' width='25%' align='right'>
            <a href='#' onclick='guarda()'>
                <img src='img/32px-Crystal_Clear_device_zip_unmount.png' border=0 height='20' width='20' alt='Guardar'>
            </a>
        </td>
