...
$consultappm = mysqli_query($link, $consultappm);
$rowppm      = mysqli_fetch_array($consultappm);
?>
<table class='Tbl0' border='0'>
    <tr>
        <td class='Td2' width='20%' align='right'>Fecha del Sorteo:</td>
        <td class='Td2'>
            <input type='text' name='fsor_ppm' size='10' maxlength='10' value='<?php echo cambiafechadmy($rowppm['fsor_ppm']); ?>'>
        </td>
    </tr>
    <tr>
        <td class='Td2' width='20%' align='right'>Nota Para el Sorteo:</td>
        <td class='Td2'>
            <textarea name='nota_ppm' rows='6' cols='150'><?php echo $rowppm['nota_ppm']; ?></textarea>
            <a href='#' onclick='validar()'>
                <img src='img/32px-Crystal_Clear_device_zip_unmount.png' border=0 height='20' width='20' title='Guardar'>
            </a>
        </td>
    </tr>
</table>
<table class='Tbl0' border='0'>
    ...
    if (!empty($rowppm['codi_ppm'])) {
        $codi_ppm    = mysqli_real_escape_string($link, $rowppm['codi_ppm']);
        $consultapre = "SELECT codi_pre, desc_pre FROM premio WHERE codi_ppm='$codi_ppm'";
        $consultapre = mysqli_query($link, $consultapre);

        while ($rowpre = mysqli_fetch_array($consultapre)) {
            echo "<tr>";
...
<table class='Tbl0'>
    <tr>
        <td class='Td2' width='25%' align='right'>
            <a href='cse_plan11.php'>
                <img src='img/32px-Crystal_Clear_mimetype_document2.png' border=0 height='20' width='20' alt='Nuevo'>
            </a>
        </td>
        <td class='Td2' width='25%' align='left'><a href='cse_plan11.php'>Nuevo</a></td>
        <td class='Td2' width='25%' align='right'>
            <a href='#' onclick='atras()'>
                <img src='img/32px-Crystal_Clear_action_1leftarrow.png' border=0 height='20' width='20' alt='Regresar'>
            </a>
        </td>
